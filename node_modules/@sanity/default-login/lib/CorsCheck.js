...
class CorsCheck extends _react.PureComponent {
  ...
  render() {
    ...
    if (result.isCorsError) {
      return this.renderWrapper(_react.default.createElement("p", null, "It looks like the error is being caused by the current origin (", _react.default.createElement("code", null, origin), ") not being allowed for this project. If you are a project administrator or developer, you can head to", ' ', _react.default.createElement("a", {
        rel: linkRel,
        target: "_blank",
        href: corsUrl
      }, "the project management"), ' ', "interface. Add the origin under the ", _react.default.createElement("a", {
        href: "https://www.sanity.io/docs/front-ends/cors",
        target: "_blank",
        rel: "noopener noreferrer"
      }, _react.default.createElement("em", null, "CORS Origins")), " section. Do remember to", ' ', _react.default.createElement("code", null, "allow credentials"), "!"));
    }

    if (result.pingResponded) {
      return this.renderWrapper(_react.default.createElement("p", null, "Our diagnostics cannot quite determine why this happened. If it was a network glitch you could try hitting the ", _react.default.createElement("strong", null, "Retry"), " button below. If you are working as a developer on this project, you could also have a look at the browser's dev console and see if any issues are listed there."));
    }

    return this.renderWrapper(_react.default.createElement("p", null, "It might be that your internet connection is unstable or down. You could try hitting the", ' ', _react.default.createElement("strong", null, "Retry"), " button to see if it was just a temporary glitch."));
  }
